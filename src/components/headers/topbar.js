                    ...
                    <div className="col-lg-12">
                        <div className="topbar_text">
                            ...
                            href={'tel:'+ topBarData.crbThemeOptions.citPhone}>
                                <span><img src={callIcon} alt="icon" /></span>
                                {topBarData.crbThemeOptions.citPhone}</a>
                            <a 
                            data-sal="slide-left"
                            data-sal-delay="300"
                            data-sal-duration="800"
                            data-sal-easing="ease"
                            href={'mailto:'+ topBarData.crbThemeOptions.citEmail}><span>
                                <img src={topMail} alt="icon" /></span>
                                {topBarData.crbThemeOptions.citEmail}</a>
                        </div>
                    </div>
                </div>
            </div>
